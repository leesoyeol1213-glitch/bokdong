...
const MASCOTS=[
  {id:'m_gang', region:'강원', name:'산양',      emoji:'🐐', boost:{mhpBonus:15},      desc:'설악산의 산양 · 최대 체력 +15'},
  {id:'m_gyeonggi',region:'경기',name:'해치',    emoji:'🦁', boost:{hpRegen:1},         desc:'서울을 지키는 해치 · 체력 회복 +1/초'},
  {id:'m_gyeong',region:'경상', name:'갈매기',    emoji:'🕊️', boost:{speedBonus:2},      desc:'부산의 갈매기 · 속도 +2'},
  {id:'m_jeon', region:'전라',  name:'진돗개',    emoji:'🐕', boost:{xpBonus:0.05},      desc:'진도의 진돗개 · 경험치 +5%'},
  {id:'m_chung',region:'충청',  name:'황새',      emoji:'🦢', boost:{moneyBonus:0.05},   desc:'예산의 황새 · 수입 +5%'},
...
const OX_BY_CITY={
  ...
  '나라':[
    {q:'나라 공원에는 사슴이 자유롭게 돌아다닌다.',a:true,ex:'신의 사자로 여겨져 보호'},
    {q:'도다이지의 대불(큰 불상)은 나라에 있다.',a:true,ex:'세계 최대급 청동 대불'},
    {q:'나라는 교토보다 나중에 일본의 수도가 되었다.',a:false,ex:'나라(710년)가 교토(794년)보다 먼저'},
  ],
  '히로시마':[
    {q:'미야지마의 이쓰쿠시마 신사 도리이는 바다 위에 서 있다.',a:true,ex:'밀물 때 물에 떠 보임'},
    {q:'히로시마는 1945년 원자폭탄이 투하된 도시다.',a:true,ex:'평화기념공원'},
    {q:'히로시마풍 오코노미야키는 면을 넣는 것이 특징이다.',a:true,ex:'오사카풍과 다른 층층이 방식'},
  ],
  '오키나와':[
    {q:'오키나와는 옛 류큐 왕국이 있던 곳이다.',a:true,ex:'슈리성이 그 상징'},
    {q:'오키나와는 아열대 기후의 휴양지다.',a:true,ex:'에메랄드빛 바다'},
    {q:'오키나와는 일본 홋카이도 바로 옆에 있다.',a:false,ex:'일본 최남단, 홋카이도는 최북단'},
  ],
  // 🇨🇳 중국 도시 OX
  '베이징':[
    {q:'자금성은 명·청 황제가 살던 궁궐이다.',a:true,ex:'약 500년간 24명의 황제'},
    {q:'만리장성은 우주에서 맨눈으로 또렷이 보인다.',a:false,ex:'맨눈으로는 보이지 않는 속설'},
    {q:'베이징은 중국의 수도다.',a:true,ex:'정치·문화 중심'},
  ],
  '상하이':[
    {q:'동방명주 타워는 상하이 푸둥에 있다.',a:true,ex:'와이탄 강 건너편 랜드마크'},
    {q:'상하이는 중국 최대급 경제·금융 도시다.',a:true,ex:'황푸강변 국제도시'},
    {q:'와이탄은 사막 지대의 이름이다.',a:false,ex:'황푸강변 유럽식 건물 거리'},
  ],
  '시안':[
    {q:'시안의 병마용은 진시황릉을 지키는 흙 병사다.',a:true,ex:'8천여 개, 1974년 발견'},
    {q:'시안은 실크로드의 동쪽 출발점이었다.',a:true,ex:'옛 이름 장안(長安)'},
    {q:'병마용은 모두 똑같은 얼굴로 만들어졌다.',a:false,ex:'제각기 다른 표정·생김새'},
  ],
  '청두':[
    {q:'청두는 자이언트 판다의 대표 서식지다.',a:true,ex:'판다 번식연구기지로 유명'},
    {q:'마파두부·훠궈는 쓰촨(사천) 요리다.',a:true,ex:'매운 마라 맛'},
    {q:'청두는 중국에서 가장 더운 사막 도시다.',a:false,ex:'분지 기후, 판다의 고향'},
  ],
  '구이린':[
    {q:'"계림산수 갑천하"는 구이린 풍경을 칭송한 말이다.',a:true,ex:'천하제일의 산수'},
    {q:'구이린의 뾰족한 봉우리는 석회암 카르스트 지형이다.',a:true,ex:'이강을 따라 형성'},
    {q:'구이린은 눈 덮인 고산 스키 도시다.',a:false,ex:'아열대 강·봉우리 절경'},
  ],
  '홍콩':[
    {q:'홍콩은 1997년 영국에서 중국으로 반환됐다.',a:true,ex:'일국양제 시행'},
    {q:'홍콩의 이층 트램은 100년 넘게 운행 중이다.',a:true,ex:'1904년 개통'},
    {q:'홍콩은 내륙이라 바다가 없다.',a:false,ex:'빅토리아 항구의 도시'},
  ],
  '하얼빈':[
    {q:'하얼빈 빙설제는 세계 최대급 얼음 축제다.',a:true,ex:'매년 겨울 얼음궁전'},
    {q:'하얼빈은 러시아와 가까워 유럽풍 건축이 많다.',a:true,ex:'성 소피아 성당 등'},
    {q:'하얼빈은 중국 남부의 열대 도시다.',a:false,ex:'북부, 혹독한 겨울'},
  ],
  // 🌴 동남아 도시 OX
  '싱가포르':[
    {q:'머라이언은 사자 머리에 물고기 몸을 한 싱가포르 상징이다.',a:true,ex:'입에서 물을 뿜음'},
    {q:'싱가포르는 섬 전체가 하나의 나라인 도시국가다.',a:true,ex:'동남아 금융 허브'},
    {q:'싱가포르는 겨울에 눈이 내린다.',a:false,ex:'적도 부근 열대, 눈 안 옴'},
  ],
  '방콕':[
    {q:'방콕은 태국의 수도다.',a:true,ex:'차오프라야강변'},
    {q:'툭툭은 방콕의 삼륜 택시다.',a:true,ex:'대표 교통수단'},
    {q:'방콕에는 배 위에서 물건을 파는 수상시장이 있다.',a:true,ex:'담넌사두억 등'},
  ],
  '하롱베이':[
    {q:'하롱베이는 베트남의 유네스코 세계자연유산이다.',a:true,ex:'수천 개 석회암 섬'},
    {q:'"하롱"은 "내려오는 용"이라는 뜻이다.',a:true,ex:'용 전설에서 유래'},
    {q:'하롱베이는 사막 한가운데 있다.',a:false,ex:'에메랄드빛 바다의 절경'},
  ],
  '발리':[
    {q:'발리는 인도네시아의 섬이다.',a:true,ex:'"신들의 섬"'},
    {q:'발리는 주민 대부분이 힌두교를 믿는다.',a:true,ex:'인니 내 이슬람 다수와 대조'},
    {q:'발리에는 계단식 논(라이스 테라스)이 있다.',a:true,ex:'유네스코 등재 경관'},
  ],
  '앙코르와트':[
    {q:'앙코르와트는 캄보디아의 거대한 사원 유적이다.',a:true,ex:'크메르 제국이 건설'},
    {q:'앙코르와트는 캄보디아 국기에 그려져 있다.',a:true,ex:'국가의 상징'},
    {q:'앙코르와트는 현대에 콘크리트로 지어졌다.',a:false,ex:'12세기 돌로 축조'},
  ],
  '세부':[
    {q:'세부는 필리핀의 유명한 휴양 섬이다.',a:true,ex:'백사장·다이빙 명소'},
    {q:'탐험가 마젤란이 필리핀 세부 인근에서 최후를 맞았다.',a:true,ex:'1521년 막탄 전투'},
    {q:'지프니는 필리핀의 대표 대중교통이다.',a:true,ex:'미군 지프를 개조'},
  ],
  '쿠알라룸푸르':[
    {q:'쿠알라룸푸르는 말레이시아의 수도다.',a:true,ex:'약칭 KL'},
